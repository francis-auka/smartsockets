      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-12 space-y-16">
        <div className="space-y-6">
          ...
          <p className="text-black/60 text-xl font-medium tracking-tight leading-relaxed max-w-2xl">
            We protect your home data. Smart socket activity and power usage logs are encrypted and never shared.
          </p>
        </div>

        <div className="grid gap-12">
          {[
            { title: 'Personal Data', desc: 'Secure storage of your delivery and account information.' },
            { title: 'Usage Metrics', desc: 'Energy consumption data is used only for your personal dashboard insights.' },
            { title: 'Cloud Security', desc: 'Encrypted communication between your smart plugs and the controlling app.' }
          ].map((item, i) => (
